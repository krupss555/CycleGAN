...
def train_fn(disc_H, discZ, gen_Z, gen_H, loader, opt_disc, opt_gen, l1, mse, d_scaler, g_scaler ):
    ...
    for idx, (zebra, horse) in enumerate(loop):
        ...
        opt_disc.zero_grad()
        d_scaler.scale(D_loss).backwards()
        ...
        with torch.cuda.amp.autocast():
            # adverserial loss for both the generators
...
def main():
    ...
    gen_H = Generator(img_channels=3, num_residuals=9).to(config.DEVICE)  #generate horse
    opt_disc = optim.Adam(
